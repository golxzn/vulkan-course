...
set(vc_gen_dir      ${CMAKE_BINARY_DIR}/code        CACHE PATH "Path to generated sources")
...
set(vc_project_info_file ${vc_gen_dir}/gen/core/info/project.hpp)

set(APPLICATION_NAME "Vulkan Corpse")

configure_file(
	${vc_root}/cmake/misc/project.hpp.in
	${vc_project_info_file}
